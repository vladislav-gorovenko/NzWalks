    ...
    public partial class AddSeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3f8b1a9c-5e2d-4b7a-9c1e-7d4f2a8b3e5c"), "Easy" },
                    { new Guid("9a2c4e6f-1b3d-4a8e-2f5c-6b7d9e0a3c1f"), "Medium" },
                    { new Guid("e5d7f9b1-2a4c-3e6d-8b0f-1c3a5e7d9f2b"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("3f8b1a9c-5e2d-4b7a-9c1e-7d4f2a8b3e5c"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("9a2c4e6f-1b3d-4a8e-2f5c-6b7d9e0a3c1f"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("e5d7f9b1-2a4c-3e6d-8b0f-1c3a5e7d9f2b"));
